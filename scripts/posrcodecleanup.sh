...
# curl -s https://geoportal.statistics.gov.uk/Docs/PostCodes/ONSPD_MAY_2016_csv.zip >ONSPD_MAY_2016_csv.zip
...
#remove file created from header
rm "outcodes/postcode,countingArea.csv"

#remove unneeded temp files
mv postcodesMin4.csv pc_region_votingArea_centroid.csv
rm ONSPD_MAY_2016_csv.zip
rm ONSPD_MAY_2016_UK.csv
rm postcodesMin3.csv
rm postcodesMin2.csv
rm postcodesMin1.csv

#Check files for uniform counting region
